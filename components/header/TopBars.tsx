...
function TopBar() {
    ...
    return (
        <div className="bg-[#121314] text-white text-xs py-2  relative">
            <div className="container mx-auto flex justify-between items-center px-4 sm:px-6 lg:px-8">
                <div className="flex space-x-4 hidden md:block">
                    <a href="#" className="hover:text-gray-300 transition-colors">About</a>
                    <a href="#" className="hover:text-gray-300 transition-colors">My Account</a>
                    <a href="#" className="hover:text-gray-300 transition-colors">Wishlist</a>
                    <a href="#" className="hover:text-gray-300 transition-colors">Checkout</a>
                </div>
                ...
                <div className="flex space-x-4">
                    <div className="flex items-center space-x-2">
                        <a href="#" className="hover:text-gray-300 transition-colors ">Store Location</a>
