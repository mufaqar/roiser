...
function CustomerTestimonials() {
  const testimonials: Testimonial[] = [ 
    {
      ...
      rating: 5,
      quote: "This is genuinely the first theme bought for which i did not had to write one line of ode. I would recommend everybody",
    ...
    },
    {
      ...
      rating: 5,
      quote: "Absolutely fantastic support! They went above and beyond to help me customize my theme. Highly recommend!",
    ...
    },
    {
      ...
      rating: 4,
      quote: "Great value for the price. The features are robust, and it's easy to use. A solid investment.",
  ...
  return (
    ...
    <div className="min-h-auto flex flex-col items-center justify-center  container mx-auto px-4">
      <h2 className="text-4xl font-bold text-[#121314] mb-12 text-center">What Our Customers Say</h2>
        ...
        {testimonials.map((testimonial) => (
          <div key={testimonial.id} className="flex flex-col h-full"> 
            <div className="relative bg-white rounded-xl shadow-lg p-8 w-full flex-grow"> 
              ...
              <div className="absolute bottom-[-20px] left-[40px] w-0 h-0
                                border-l-[15px] border-r-[45px] border-t-[25px]
                                border-l-transparent border-r-transparent border-t-white"></div> 

              <div className="flex justify-between items-center mb-5">
                <span className="font-bold text-[#1A1A1A] text-lg">{testimonial.quality}</span>
            ...
            <div className="flex items-center pt-10 pl-6 pr-6 -mt-2"> 
              <div className="w-12 h-12 rounded-full bg-gray-300 mr-4 overflow-hidden flex-shrink-0">
                <img src={testimonial.avatar} alt="Customer Avatar" className="w-full h-full object-cover" />
              </div>
              <div>
                <p className="font-semibold text-[#121314]">{testimonial.customerName}</p>
